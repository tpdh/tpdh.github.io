(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-1ffacd5c"], {
    "14c3": function(e, t, o) {
        var n = o("c6b6"),
        l = o("9263");
    ...
    "25f0": function(e, t, o) {
        ...
        f = c.name != r; (u || f) && n(RegExp.prototype, r, (function() {
            var e = l(this),
            t = String(e.source),
            o = e.flags,
            n = String(void 0 === o && e instanceof RegExp && !("flags" in s) ? a.call(e) : o);
            return "/" + t + "/" + n
        }), {
            unsafe: !0
        })
    ...
    5319 : function(e, t, o) {
        ...
        n("replace", 2, (function(e, t, o, n) {
            ...
            return [function(o, n) {
                ...
                return void 0 !== i ? i.call(o, l, n) : t.call(String(l), o, n)
            },
            function(e, n) {
                if (!S && g || "string" === typeof n && -1 === n.indexOf(v)) {
                    var i = o(t, e, this, n);
                ...
                while (1) {
                    ...
                    if (_.push(x), !h) break;
                    var A = String(x[0]);
                    "" === A && (s.lastIndex = c(m, a(s.lastIndex), R))
                }
                for (var y = "",
                w = 0,
                k = 0; k < _.length; k++) {
                    x = _[k];
                    for (var L = String(x[0]), U = f(p(r(x.index), m.length), 0), O = [], $ = 1; $ < x.length; $++) O.push(b(x[$]));
                    var E = x.groups;
                    if (d) {
                        var N = [L].concat(O, U, m);
                        void 0 !== E && N.push(E);
                        var M = String(n.apply(void 0, N))
                    } else M = C(L, m, U, O, E, n);
                    U >= w && (y += m.slice(w, U) + M, w = U + L.length)
                }
                return y + m.slice(w)
            }];
            function C(e, o, n, l, a, r) {
                var s = n + e.length,
                c = l.length,
                u = h;
                return void 0 !== a && (a = i(a), u = d),
                t.call(r, u, (function(t, i) {
                    var r;
                    switch (i.charAt(0)) {
                    case "$":
                        return "$";
                    ...
                    default:
                        ...
                        if (u > c) {
                            var f = m(u / 10);
                            return 0 === f ? t: f <= c ? void 0 === l[f - 1] ? i.charAt(1) : l[f - 1] + i.charAt(1) : t
                        }
                        r = l[u - 1]
                    }
                    return void 0 === r ? "": r
    ...
    6547 : function(e, t, o) {
        ...
        i = function(e) {
            return function(t, o) {
                var i, a, r = String(l(t)),
                s = n(o),
                c = r.length;
                return s < 0 || s >= c ? e ? "": void 0 : (i = r.charCodeAt(s), i < 55296 || i > 56319 || s + 1 === c || (a = r.charCodeAt(s + 1)) < 56320 || a > 57343 ? e ? r.charAt(s) : i: e ? r.slice(s, s + 2) : a - 56320 + (i - 55296 << 10) + 65536)
            }
        };
        e.exports = {
            codeAt: i(!1),
    ...
    9263 : function(e, t, o) {
        ...
        f && (r = function(e) {
            ...
            h = 0,
            b = e;
            return p && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(f.lastIndex), f.lastIndex > 0 && (!f.multiline || f.multiline && "\n" !== e[f.lastIndex - 1]) && (d = "(?: " + d + ")", b = " " + b, h++), o = new RegExp("^(?:" + d + ")", m)),
            u && (o = new RegExp("^" + d + "$(?!\\s)", m)),
            s && (t = f.lastIndex),
            l = i.call(p ? o: f, b),
            p ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = f.lastIndex, f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length: t),
            u && l && l.length > 1 && a.call(l[0], o, (function() {
                for (r = 1; r < arguments.length - 2; r++) void 0 === arguments[r] && (l[r] = void 0)
            })),
            l
        }),
        e.exports = r
    ...
    a9c7: function(e, t, o) {
        ...
        var n = function() {
            ...
            [e._v(e._s(e.backendVersion))])], 1), o("el-container", [o("el-form", {
                staticStyle: {
                    width: "100%"
                },
                attrs: {
            ...
            [o("el-row", [o("el-checkbox", {
                ...
                model: {
                    value: e.form.new_name,
                    callback: function(t) {
                        e.$set(e.form, "new_name", t)
                    },
                ...
                model: {
                    value: e.form.appendType,
                    callback: function(t) {
                        e.$set(e.form, "appendType", t)
                    },
            ...
            [o("el-row", [o("el-checkbox", {
                ...
                model: {
                    value: e.form.tpl.surge.doh,
                    callback: function(t) {
                        e.$set(e.form.tpl.surge, "doh", t)
                    },
                    expression: "form.tpl.surge.doh"
                }
            })], 1), o("el-row", [o("el-checkbox", {
                attrs: {
                    label: "Clash.DoH"
                ...
                model: {
                    value: e.form.tpl.clash.doh,
                    callback: function(t) {
                        e.$set(e.form.tpl.clash, "doh", t)
                    },
                    expression: "form.tpl.clash.doh"
                }
            })], 1), o("el-row", [o("el-checkbox", {
                attrs: {
                    label: "网易云"
                ...
                model: {
                    value: e.form.insert,
                    callback: function(t) {
                        e.$set(e.form, "insert", t)
                    },
                    expression: "form.insert"
                }
            })], 1), o("el-button", {
                attrs: {
                    slot: "reference"
            ...
            [o("el-input", {
                ...
                model: {
                    value: e.curtomShortSubUrl,
                    callback: function(t) {
                        e.curtomShortSubUrl = t
                    },
                    expression: "curtomShortSubUrl"
                }
            },
            [o("el-button", {
                directives: [{
            ...
            [e._v(" Remote config upload "), o("el-popover", {
                staticStyle: {
                    "margin-left": "10px"
                },
                attrs: {
        ...
        m = {
            data: function() {
                var e = {
                    ...
                    options: {
                        ...
                        },
                        {
                            ...
                            {
                                label: "ACL4SSR无广告拦截规则",
                                value: "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_NoReject.ini"
                            },
                            {
                                label: "ACL4SSR精简版",
                            ...
                            {
                                label: "ACL4SSR更多去广告",
                                value: "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Mini_AdblockPlus.ini"
                            },
                            {
                                label: "ACL4SSR不带自动测速",
                            ...
                            {
                                label: "ACL4SSR自动测速、故障转移、负载均衡",
                                value: "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Mini_MultiMode.ini"
                            },
                            {
                                label: "ACL4SSR带港美日国家",
                                value: "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Mini_MultiCountry.ini"
                            },
                            {
                                label: "ACL4SSR全分组",
                            ...
                            {
                                label: "ACL4SSR精简版+无自动测速",
                                value: "config/ACL4SSR_Mini_NoAuto.ini"
                            },
                            {
                                label: "ACL4SSR精简版+fallback",
                ...
                t = /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
                if (t) {
                    for (var o = e.options.remoteConfig[1].options, n = 0; n < o.length; n++) o[n].label.length > 10 && (o[n].label = o[n].label.replace(/\s.*/, ""));
                    for (var l = {},
                    i = Object.keys(e.options.customBackend), r = 0; r < i.length; r++) {
                        var s = i[r].replace(/\(.*/, "");
                        l[s] = e.options.customBackend[i[r]]
                    }
                    e.options.customBackend = l
                }
                return e
            },
            created: function() {
                document.title = "Saraphineの订阅转换",
                this.isPC = this.$getOS().isPc,
                this.form.sourceSubUrl = this.getLocalStorageItem("sourceSubUrl")
            },
            mounted: function() {
                this.form.clientType = c,
                this.form.customBackend = s,
                this.form.remoteConfig = a,
                this.notify(),
            ...
            methods: {
                ...
                clashInstall: function() {
                    ...
                    window.open(e + encodeURIComponent("" !== this.curtomShortSubUrl ? this.curtomShortSubUrl: this.customSubUrl))
                },
                ...
                makeUrl: function() {
                    ...
                    !1;
                    var t = "" === this.form.customBackend ? s: this.form.customBackend,
                    o = "" === this.form.remoteConfig ? "": this.form.remoteConfig,
                    n = this.form.sourceSubUrl;
                    if (n = n.replace(/(\n|\r|\n\r)/g, "|"), -1 !== n.indexOf("losadhwse") && ( - 1 !== t.indexOf("py6.pw") || -1 !== t.indexOf("subconverter-web.now.sh") || -1 !== t.indexOf("subconverter.herokuapp.com") || -1 !== t.indexOf("api.wcc.best"))) return this.$alert("此机场订阅已将该后端屏蔽，请自建后端转换。", "转换错误提示", {
                ...
                backendSearch: function(e, t) {
                    var o = this.options.backendOptions,
                ...
                getBackendVersion: function() {
                    var e = this;
                    this.$axios.get(s.substring(0, s.length - 5) + "/version").then((function(t) {
                        e.backendVersion = t.data.replace(/backend\n$/gm, ""),
                        e.backendVersion = e.backendVersion.replace("subconverter", "")
                    }))
                },
                saveSubUrl: function() {
                    "" !== this.form.sourceSubUrl && this.setLocalStorageItem("sourceSubUrl", this.form.sourceSubUrl)
                },
                getLocalStorageItem: function(e) {
                    ...
                    if (null !== o) {
                        var l = JSON.parse(o);
                        l.expire > t ? n = l.value: localStorage.removeItem(e)
                    }
                    return n
                },
        ...
        d = m,
        h = o("2877"),
        b = Object(h["a"])(d, n, l, !1, null, null, null);
        t["default"] = b.exports
    },
    ac1f: function(e, t, o) {
        "use strict";
    ...
    c975: function(e, t, o) {
        ...
        {
            indexOf: function(e) {
                return s ? r.apply(this, arguments) || 0 : l(this, e, arguments.length > 1 ? arguments[1] : void 0)
            }
        })
    },
    d784: function(e, t, o) {
        ...
        e.exports = function(e, t, o, f) {
            ...
            if (!h || !b || "replace" === e && (!c || !u || p) || "split" === e && !m) {
                var S = /./ [d],
                g = o(d, "" [e], (function(e, t, o, n, l) {
                    return t.exec === a ? h && !l ? {
                        done: !0,
                        value: S.call(t, o, n)
                    }: {
...
//# sourceMappingURL=chunk-1ffacd5c.b6cc770e.js.map
